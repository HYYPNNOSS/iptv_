...
export default function Hero() {
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24 overflow-hidden">
      ...
      <Image
        src="/simple-bg.png" 
        alt="IPTV France - Nos offres et formules de streaming TV"
        fill
        priority
      ...
      >
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 sm:mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
          Nos Offres IPTV - Formules Adaptées à Vos Besoins
        </h1>
        
        <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto">
          Des formules flexibles pour tous les budgets – de 1 à 12 mois, avec des prix compétitifs et une qualité premium.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 sm:mb-12">
          <Link href="#offres" className="group w-full sm:w-auto">
